---
name: opportunities
description: "Suggest Summation workflows from recent local IDE chats and the live catalog. Use when the user asks what Summation can do for their work, wants workflow ideas, use cases, how you can help, opportunity scan, or after onboarding when they consent to a local chat scan."
---
