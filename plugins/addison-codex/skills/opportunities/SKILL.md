---
name: opportunities
description: "Suggest Summation workflows from recent Codex or Codex chats and the live catalog. Use when the user asks what Summation can do for their work, wants workflow ideas, use cases, how you can help, opportunity scan, or after onboarding when they consent to a local chat scan."
---
...
> I can scan recent **local** Codex / Codex sessions on this machine for themes (metrics, SQL, reports, CSVs, …). Nothing is uploaded. I only show short theme summaries, not full transcripts. OK?
